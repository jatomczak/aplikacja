    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_from', models.DateField(default=datetime.datetime(2019, 7, 30, 8, 57, 9, 384958, tzinfo=utc))),
                ('date_to', models.DateField(default=datetime.datetime(2019, 7, 30, 8, 57, 9, 384958, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='VacationsList',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vacation_date', models.DateField(default=datetime.datetime(2019, 7, 30, 8, 57, 9, 384958, tzinfo=utc))),
